...
@Setter
@Embeddable
public class UserChatReadId implements Serializable {
    private static final long serialVersionUID = -1039085823317269234L;
    @NotNull
    ...
    public boolean equals(Object o) {
        ...
        UserChatReadId entity = (UserChatReadId) o;
